        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <div className="flex items-center">
              ...
              >
                ...
                <span className="text-lg font-bold">THE MORTGAGE BUREAU</span>
              </Link> */}
            </div>
            ...
            <nav className="flex flex-col gap-1 p-4">
              ...
              <div className="mt-4 space-y-3 border-t border-white/10 pt-4">
                <Button
                  className="w-full justify-center gap-2 border-white/40 text-white hover:bg-white hover:text-[#1a2f5e] transition-all duration-300 group relative overflow-hidden"
                  variant="outline"
                  onClick={() => setIsOpen(false)}
                >
                  <span className="relative z-10 flex items-center gap-2">
                ...
                <Button
                  className="w-full justify-center gap-2 bg-[#1bb5a7] hover:bg-[#14998d] text-white transition-all duration-300 shadow-lg shadow-[#1bb5a7]/30"
                  onClick={() => setIsOpen(false)}
                >
                  <FileText className="h-4 w-4" />
                  APPLY NOW
